        ...
        if ($('#map-canvas-fs').length) {
            ...
            google.maps.event.addDomListener(window, 'load', function () {
                var mapOptions = {
                    scrollwheel: false,
                    zoom: 11,
                    center: new google.maps.LatLng(0,0) // map coordinates
                };

                map = new google.maps.Map(document.getElementById('map-canvas-fs'),
                    mapOptions);
                marker = new google.maps.Marker({
                    position: new google.maps.LatLng(0,0), // marker coordinates
                    map: map,
                    icon: image,
                    title: 'Hello World!'
                });
                ...
                marker5 = new google.maps.Marker({
                    position: new google.maps.LatLng(40, 0), // marker coordinates
                    map: map,
                    icon: image,
                    title: 'Hello World!'
                });
    ...
    if ($('#map-canvas').length) {
        ...
        google.maps.event.addDomListener(window, 'load', function () {
            var mapOptions = {
                scrollwheel: false,
                zoom: 12,
                center: new google.maps.LatLng(31.54505, 74.340683) // map coordinates
            };

            map = new google.maps.Map(document.getElementById('map-canvas'),
                mapOptions);
            marker = new google.maps.Marker({
                position: new google.maps.LatLng(31.54505, 74.340683), // marker coordinates
                map: map,
                icon: image,
                title: 'Hello World!'
            });
            marker2 = new google.maps.Marker({
                position: new google.maps.LatLng(31.516667, 74.383333), // marker coordinates
                map: map,
                icon: image,
                title: 'Hello World!'
            });
            marker3 = new google.maps.Marker({
                position: new google.maps.LatLng(31.5312396, 74.4245747), // marker coordinates
                map: map,
                icon: image,
                title: 'Hello World!'
            });
